...
Skilled Spec brings OpenSpec's proven workflow to Claude Code through four composable skills that activate automatically when you talk to Claude. No CLI tools, no commands to memorize—just describe what you want to do.
...
Skilled Spec is **inspired by OpenSpec** but reimagined for Claude Code's native capabilities:
...
| Without Specs | With Skilled Spec |
|---------------|------------------------|
...
# Plugin: .claude/plugins/skilled-spec/skills/
# Direct: .claude/skills/

# Update references (macOS/Linux)
find .claude/plugins/skilled-spec/skills -name "SKILL.md" -exec sed -i '' 's/spec\//myspecs\//g' {} \;
